...
<?php foreach ($items as $item): ?>
	...
	<tr id="item_<?php echo h($item['Item']['id']); ?>">
		...
		<td>
			<?php echo $this->Html->link('<img width=160px height=130px src="/Raiber_Project/item_img/'.$item['Item']['image1_file_name'].'">',array('action' => 'view', $item['Item']['id']),array('escape'=>false)); ?>
		</td>
